  ...
  try {
    ...
    if (type === "pengiriman") {
      ...
      const res = await client.query(
        ...
        ${whereSql}
        GROUP BY o.id, c.id, c.name, c.phone, o.no_struk, a.kecamatan, a.shipping_zone, a.kota, o.shipping_address, c.address, c.patokan, o.grand_total, o.payment_bank, ch.name
